            ...
            item {
                Card {
                    Column(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        Button(onClick = { onSignInPersonal(personalName) }) { Text("Use personal mode") }
                ...
                Card {
                    Column(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            LicensePlan.entries.forEach { plan ->
                                Button(onClick = { onSetPlan(plan) }) { Text(plan.name) }
                            }
                        }
                    }
                }
            ...
            item {
                Card {
                    Column(modifier = Modifier.fillMaxWidth().padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        Button(onClick = onGenerateDiagnostics) { Text("Generate diagnostics bundle") }
